...
An SST file is a sorted data file that RocksDB can add directly to its storage. The details of how RocksDB writes and organizes SST files are covered in [ROCKSDB 605: RocksDB LSM Tree](605.md). For this chapter, it is enough to think of the files as a bulk representation of the Region's key-value state.
