...
This chapter establishes the normal merge path. [RAFTSTORE 901: Peer Lifecycle and Crash Recovery](901.md) will examine how durable peer states, snapshots, and crash recovery preserve the same result when these steps are interrupted.
