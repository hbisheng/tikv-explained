...
![Replicas applying writes in the same order](images/replica-state-flow.png)
...
![Raft log entries applied from left to right](images/raft-log-order.png)
...
<img class="raft-election-image" src="images/raft-leader-election.png" alt="Raft leader election states">
